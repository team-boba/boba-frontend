...
export class VisaStatusManagementComponent {
  ...
  // displayedColumns = ['full name', 'work authorization', 'expiration date', 'day left', 'action required'];
  // dataSource = new VisaDataSource();

  // isExpansionDetailRow = (i: number, row: Object) => row.hasOwnProperty('detailRow');
  // expandedElement: any;

  // dataSource = this.visaManagementRequests;
